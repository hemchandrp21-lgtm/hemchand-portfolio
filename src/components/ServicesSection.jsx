...
function ServicesSection() {
  ...
  return (
    <section className="relative w-full bg-[#050505] text-white py-28 px-6 lg:px-12 border-t border-zinc-900 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold uppercase tracking-tight text-zinc-100">
              SERVICES & DISCIPLINE
            </h2>
          </div>
          <Link
            to="/services"
            className="mt-4 md:mt-0 text-xs font-bold uppercase tracking-widest text-zinc-400 hover:text-white transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-0 divide-y divide-zinc-900 border-t border-b border-zinc-900">
              ...
              >
                <div className="flex items-baseline gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-sm mt-1 max-w-md group-hover:text-zinc-400 transition-colors">
                      {service.desc}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 sm:mt-0 text-right">
                  <span className="text-xs font-mono tracking-widest text-zinc-600 group-hover:text-amber-400 uppercase transition-colors">
                    [DETAILS]
                  </span>
                </div>
              </div>
          ...
          <div className="hidden lg:block lg:col-span-5 sticky top-28">
            <div className="relative aspect-[4/5] rounded-sm overflow-hidden border border-zinc-800 shadow-2xl bg-zinc-950">
              <img
                src={activeImage}
                alt="Service Preview"
              ...
              <div className="absolute bottom-4 left-4 right-4 text-xs font-mono tracking-widest text-zinc-400 uppercase bg-black/60 backdrop-blur-md px-4 py-2 rounded-sm border border-zinc-800">
