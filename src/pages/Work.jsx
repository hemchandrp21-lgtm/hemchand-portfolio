...
function Work() {
  ...
  return (
    <div className="min-h-screen bg-[#040507] text-white selection:bg-[#A93207] selection:text-white relative font-sans">
      ...
      <main className="pt-24 sm:pt-32 pb-24 px-4 sm:px-12 lg:px-16 relative z-10">
        <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12">
          
          {/* Work Hero Header Banner */}
          <div className="space-y-3 sm:space-y-4 border-b border-white/10 pb-6 sm:pb-8">
            <span className="text-[11px] sm:text-xs font-mono tracking-[0.3em] uppercase text-[#A93207] font-bold block">
              PORTFOLIO ARCHIVE
            </span>
            <h1 className="text-3xl sm:text-6xl lg:text-7xl font-display uppercase tracking-tight leading-none text-white font-extrabold">
              FEATURED <span className="text-[#A93207]">CASES</span> &amp; PROJECTS
            </h1>
            <p className="text-xs sm:text-base text-zinc-400 font-mono max-w-2xl leading-relaxed uppercase">
              CURATED SELECTION OF END-TO-END UX RESEARCH, USABILITY TESTING, MOBILE APPS, AND DIGITAL DESIGN SYSTEMS.
            </p>
          </div>

          {/* CATEGORY FILTER TABS & SEARCH BAR (Swipeable on Mobile) */}
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 bg-[#080b12] p-2.5 sm:p-3 rounded-2xl border border-white/10 shadow-xl">
            
            {/* Category Filter Buttons (Horizontal Swipeable Bar on Phones) */}
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1 w-full md:w-auto shrink-0">
              {categories.map((cat) => {
                const Icon = cat.icon;
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center gap-2 px-3.5 py-2 rounded-full font-mono text-[11px] sm:text-xs tracking-wider uppercase transition-all duration-300 border cursor-pointer shrink-0 min-h-[38px] ${
                      isActive
            ...
            <div className="relative w-full md:w-auto md:min-w-[220px]">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-full bg-white/5 border border-white/10 text-white font-mono text-xs uppercase placeholder:text-zinc-600 focus:outline-none focus:border-white/30 transition-colors min-h-[40px]"
              />
            </div>
          </div>
                    ...
                    >
                      ...
                      >
                        <TiltCard
                          ...
                          glareEnable={true}
                          glareMaxOpacity={0.2}
                          className="rounded-3xl overflow-hidden bg-[#080b12] border border-white/15 flex flex-col justify-between hover:border-[#A93207]/60 transition-all duration-300 h-full shadow-2xl"
                        >
                          ...
                          <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                            ...
                            <div className="pt-4 border-t border-white/10 flex items-center justify-between gap-3 font-mono text-xs">
                              <span className="flex-1 inline-flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-white text-black font-bold uppercase text-[11px] tracking-wider group-hover:bg-[#A93207] group-hover:text-white transition-all shadow-md">
